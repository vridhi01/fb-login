...
use Excellence\FacebookLogin\Model\Facebook\ApiException;
/**
* AbstractFacebook Class
*/
abstract class AbstractFacebook
{
	/**
     * Version.
     */
    ...
    public function __construct($config)
    {
        ...
        $this->request = $om->get('Magento\Framework\App\RequestInterface');
    ...
    public function getSignedRequest()
    {
        if (!$this->signedRequest) {
            if (!empty($this->request->getParam('signed_request'))) {
                $this->signedRequest = $this->parseSignedRequest(
                    $this->request->getParam('signed_request'));
            }
        }
    ...
    protected function getCode()
    {
        if (!empty($this->request->getParam('code'))) {
            if ($this->state !== null &&
                !empty($this->request->getParam('state')) &&
                $this->state === $this->request->getParam('state')
            ) {
